...
- Promise magic without substance
- Hide the mechanism (shows how it works)
- Claim exclusive power
- Create dependency
...
- **Sage** - Magician + Sage = transformative wisdom
- **Creator** - Magician + Creator = visionary craft
- **Visionary tone** - Magician + visionary = category creation
